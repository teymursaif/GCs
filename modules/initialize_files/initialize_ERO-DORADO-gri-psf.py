...
def initialize_params() :
    ...
    ### (if ZP, EXPTIME and GAIN are missing from the header, define them for a given filter)
    INPUT_ZP = {'VIS':30,'NISP-Y':30,'NISP-J':30,'NISP-H':30,'g':30,'r':30,'i':30}
    INPUT_EXPTIME = {'VIS':1,'NISP-Y':1,'NISP-J':1,'NISP-H':1,'g':1,'r':1,'i':1}
    INPUT_GAIN = {'VIS':2,'NISP-Y':1,'NISP-J':1,'NISP-H':1,'g':1,'r':1,'i':1}
    ...
    TARGETS.append(['1 ERO-DORADO ERO-DORADO 064.612146 -56.112798 20 g,r,i MODEL_PSF ---']) #NISP-H,NISP-Y
    ...
    main_data_dir = working_directory+'ERO-data/ERO-DORADO/'#input_dir+'main_data/'
